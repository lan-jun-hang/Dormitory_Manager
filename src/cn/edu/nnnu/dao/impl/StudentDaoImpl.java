...
public class StudentDaoImpl implements StudentDao {
    ...
    public List<Student> search(String key, String value) {
        Connection connection = JDBCUtil.getConnection();
        String sql = "select s.id,s.number,s.name,s.gender,s.dormitory_id,d.name ,s.state,s.create_date from student s,dormitory d WHERE s.id = d.id and s." + key + " like '%" + value + "%'";
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        List<Student> list = new ArrayList<>();
        try {
    ...
    public Integer update(Student student) {
        Connection connection = JDBCUtil.getConnection();
        String sql = "update student set name = ?,gender = ?,dormitory_id = ? where id = ?";
        PreparedStatement statement = null;
        Integer result = null;
        try {
            statement = connection.prepareStatement(sql);
            ...
            statement.setInt(3, student.getDormitoryId());
    ...
    public List<Student> moveOutList() {
        Connection connection = JDBCUtil.getConnection();
        String sql = "select s.id,s.number,s.name,s.gender,s.dormitory_id,d.name ,s.state,s.create_date from student s,dormitory d WHERE s.id = d.id AND s.state = '入住'";
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        List<Student> list = new ArrayList<>();
        try {
    ...
    public List<Student> searchForMoveOut(String key, String value) {
        Connection connection = JDBCUtil.getConnection();
        String sql = "select s.id,s.number,s.name,s.gender,s.dormitory_id,d.name ,s.state from student s,dormitory d WHERE s.id = d.id and s. " + key + " LIKE '%" + value + "%'";
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        List<Student> list = new ArrayList<>();
        try {
